...
from flask_travel import app, db

# Import specific packages from flask
from flask import render_template,request,redirect,url_for

#Import Our Form(s)
from flask_travel.forms import UserInfoForm, LoginForm, CnForm

# Import of our Model(s) for the Database
from flask_travel.models import User,Cn,check_password_hash 
...
@app.route('/portal')
def portal():
    # The following line is selecting all the information from post and displaying on the portal page
    cns = Cn.query.all()
    return render_template('portal.html',user_cns = cns)
